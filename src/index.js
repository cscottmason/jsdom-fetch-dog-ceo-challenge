...
function addImage (dogPics) {
    let dogCotainer = document.querySelector('#dog-image-container');
    let newImg = document.createElement('img');
    newImg.src = dogPics;
    dogCotainer.appendChild(newImg);
}
...
function removeBreed (element) {
    let child= element.lastElementChild;
    while (child) {
        element.removeChild(breed);
...
let breedList = document.querySelectorAll('#breed-dropdown');
